...
public class UserController {
	 ...
	 * 
	 * @ApiOperation(value =
	 * "Logs the specified user device and clears the refresh tokens associated with it"
	 * ) public ResponseEntity logoutUser(@CurrentUser CustomUserDetails
	 * customUserDetails,
	 * 
	 * @ApiParam(value = "The LogOutRequest payload") @Valid @RequestBody
	 * LogOutRequest logOutRequest) { userService.logoutUser(customUserDetails,
	 * logOutRequest); return ResponseEntity.ok(new ApiResponse(true,
	 * "Log out successful")); }
	 */
}
